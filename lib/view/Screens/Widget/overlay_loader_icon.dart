...
class OverlayLoaderWithAppIcon extends StatelessWidget {
  ...
  const OverlayLoaderWithAppIcon({super.key, required this.isLoading, required this.child, required this.appIcon, this.appIconSize=50,
            ...
            children: [
              Positioned(
                ...
                child: CircularProgressIndicator(
                  color:circularProgressColor?? Colors.orangeAccent,
                  strokeWidth: 2,
                ),
              ),
              SizedBox(
